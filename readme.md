...
<figure>
  <img src="./screenshots/details.png" width="80%" alt="Details Section">
 ...
 <figure>
    <img src="./screenshots/comments.png" width="80%" alt="Comments Section"> 
...
<br/>
 ...
 <figure>
   <img src="./screenshots/final-comments.png" width="80%" alt="Final Comments Section"> 
...
Additionally, from figure 4 it can be seen that the last *Next* button attempts a form submission as the data will appear on the address bar after the button is clicked.
 ...
 <figure>
    <img src="./screenshots/form-submit-get-data.gif" width="80%" alt="Details Section"> 
...
<figure>
    <img src="./screenshots/form-animations.gif" width="80%" alt="Details Section">  
...
<figure>
    <img src="./screenshots/data-from-laravel-api.gif" width="80%" alt="Details Section">
 ...
 <figure>
    <img src="./screenshots/data-through-axios.gif" width="80%" alt="Details Section"> 
